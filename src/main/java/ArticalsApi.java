...
public class ArticalsApi {
	
	public static void ArticalsApi() throws IOException, InterruptedException {
    ...
    HttpRequest request = HttpRequest.newBuilder()
            .uri(URI.create("https://api.nytimes.com/svc/mostpopular/v2/shared/1/facebook.json?api-key=FcDfZ3AZLbdehhTWZ8KlzhVQSFnsqYLC"))
